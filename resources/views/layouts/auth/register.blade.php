...
@section('content')
    ...
    <form method="post" action="{{ route('register.perform') }}">
        ...
        <img class="mb-4" src="{!! url('https://e7.pngegg.com/pngimages/719/649/png-clipart-laravel-software-framework-php-web-framework-model-view-controller-framework-angle-text.png') !!}" alt="" width="72" height="57">
